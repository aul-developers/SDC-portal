...
import { CalendarIcon, Plus, X, User, FileText, Clock, AlertTriangle, Scale, Users } from "lucide-react"
...
export function AddPunishmentDialog({ open, onOpenChange, onSuccess }: AddPunishmentDialogProps) {
  ...
  const addCaseId = () => {
    if (currentCaseId.trim() && !caseIds.includes(currentCaseId.trim().toUpperCase())) {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
               ...
               <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={punishmentType} onValueChange={setPunishmentType} required>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Architechture">Architechture</SelectItem>
                      <SelectItem value="Accounting">Accounting</SelectItem>
                      <SelectItem value="ass Communication">Mass Communication</SelectItem>
                      <SelectItem value="Business Admin">Business Admin</SelectItem>
                      <SelectItem value="research_integrity_training">International Relations</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={punishmentType} onValueChange={setPunishmentType} required>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="disciplinary_probation">Disciplinary Probation</SelectItem>
                      ...
                      <SelectItem value="counseling">Mandatory Counseling</SelectItem>
                      <SelectItem value="research_integrity_training">Research Integrity Training</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={durationType} onValueChange={setDurationType}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="academic_years">Academic Years</SelectItem>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    className="flex-1"
                  />
                  <Button type="button" onClick={addCaseId} size="sm" className="gap-1">
                    <Plus className="h-4 w-4" />
                    Add
                  </Button>
                </div>
                <p className="text-sm text-muted-foreground">
                  Enter case IDs one by one. Press Enter or click Add to include each case.
                </p>
              </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {caseIds.map((caseId) => (
                      <Badge key={caseId} variant="secondary" className="gap-1">
                        {caseId}
                        <X className="h-3 w-3 cursor-pointer" onClick={() => removeCaseId(caseId)} />
                      </Badge>
                    ))}
                  </div>
                </div>
