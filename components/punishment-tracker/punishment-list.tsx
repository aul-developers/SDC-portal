...
import { Search, Filter, MoreHorizontal, Eye, Edit, CheckCircle, ChevronDown } from "lucide-react"
...
export function PunishmentList({ onViewDetails }: PunishmentListProps) {
  ...
  const punishmentTypes = Array.from(new Set(mockPunishments.map((punishment) => punishment.type)))
