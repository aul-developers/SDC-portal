...
export function GroupedCaseManagement() {
  const [selectedGroupedCase, setSelectedGroupedCase] = useState<string | null>(
    null
  );
      ...
      case "details":
        return (
          <div className="space-y-6">
            ...
            {selectedGroupedCase && (
              <GroupedCaseDetails groupedCaseId={Number(selectedGroupedCase)} />
            )}
          </div>
        );
      case "create":
            ...
            <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
              <div>
                <h1 className="text-2xl font-semibold text-sdc-navy">
                  Grouped Case Management
                </h1>
                <p className="mt-2 text-sm text-sdc-gray">
                  View and manage cases involving multiple students or related
                  incidents.
                </p>
              </div>
              <Button
                onClick={handleCreateGroupedCase}
