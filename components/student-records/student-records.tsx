...
export function StudentRecords() {
      ...
      case "profile":
        return (
          <div className="space-y-4">
            ...
            {selectedStudent && (
              <StudentProfile matricNumber={selectedStudent} />
            )}
          </div>
        );
      case "caseHistory":
        return (
          <div className="space-y-4">
            ...
            {selectedStudent && (
              <StudentCaseHistory matricNumber={selectedStudent} />
            )}
          </div>
        );
      default:
        return (
          <>
            ...
            <EnhancedStudentList
              ...
              onViewCaseHistory={handleViewCaseHistory}
            />
          </>
        );
    }
  ...
  return <div className="flex flex-col space-y-6">{renderContent()}</div>;
}
